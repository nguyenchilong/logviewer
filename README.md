...
- Here is new version update for can load multiple files in logs folder, 
  and you can rotate log file into small file to fix issue big file will show error `LIMIT MEMORY RAM` 
